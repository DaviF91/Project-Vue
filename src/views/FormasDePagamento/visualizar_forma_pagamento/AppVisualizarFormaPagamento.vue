<template>
    <TransitionRoot :show="Store.actionButtonSelected == 'Visualizar Forma de Pagamento'" as="template">
                ...
                <div class="flex min-h-full items-center justify-center p-4 text-center"> 
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95" style="max-width: 79rem;" enter-to="opacity-100 scale-100" leave="duration-200 ease-in" leave-from="opacity-100 scale-100" leave-to="opacity-0 scale-95">
                        <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                            <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900 text-center"> Visualizar Forma de Pagamento </DialogTitle>
                            <button style="position: absolute;"></button>
                            <FormsVisualizarFormaPagamento />
                            ...
                            <div class="flex flex-row-reverse">
                                ...
                                <button type="button"  @click="Editar"  class="m-3 inline-flex justify-center rounded-md border border-transparent bg-blue-100 px-4 py-2 text-sm font-medium text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
                                    Editar
                                </button>
                            </div>
                        </DialogPanel>
...
<script>
  import FormsVisualizarFormaPagamento from './FormsVisualizarFormaPagamento.vue';
  import AppEditarFormaPagamento from '../editar_forma_pagamento/AppEditarFormaPagamento.vue';

  export default {
    components: {
        FormsVisualizarFormaPagamento,
        AppEditarFormaPagamento
    },
    data() {
        return {
            editar: false
